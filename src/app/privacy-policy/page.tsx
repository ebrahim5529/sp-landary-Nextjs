...
export const metadata = {
    title: "سياسة الخصوصية - الفرسان المغاسل",
    description: "سياسة الخصوصية وحماية البيانات الشخصية لنظام الفرسان المغاسل وفقاً للأنظمة المعمول بها في المملكة العربية السعودية.",
};
                ...
                <div className="max-w-4xl mx-auto">
                    ...
                    <Card className="mb-6">
                        ...
                        <CardContent className="space-y-4 text-muted-foreground">
                            <p>
                                نحن في الفرسان المغاسل ملتزمون بحماية خصوصيتك وبياناتك الشخصية. تشرح هذه السياسة كيفية جمع واستخدام وحماية معلوماتك الشخصية وفقاً لنظام حماية البيانات الشخصية في المملكة العربية السعودية.
                            </p>
                            <p>
