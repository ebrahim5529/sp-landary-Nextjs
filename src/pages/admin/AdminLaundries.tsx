...
import { Building2, Search, Edit, Trash2, Eye, Plus, Mail, Phone, MapPin, FileText } from "lucide-react";
...
export default function AdminLaundries() {
  ...
  const handleView = (laundry: LaundryOwner) => {
    // الانتقال إلى صفحة البروفايل الاحترافية
    navigate(`/admin/laundries/${laundry.id}`);
  };
